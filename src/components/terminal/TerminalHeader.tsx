  ...
  if (osTheme === 'windows') {
    return (
      <div className="flex items-center p-1 bg-blue-900 text-white">
        ...
        <div className="flex">
          <button className="px-2 hover:bg-blue-700" onClick={(e) => e.stopPropagation()}>_</button>
          <button className="px-2 hover:bg-blue-700" onClick={(e) => e.stopPropagation()}>□</button>
          <button className="px-2 hover:bg-red-600" onClick={(e) => e.stopPropagation()}>×</button>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="flex flex-col">
        <div className="flex items-center p-1 bg-gray-800 text-gray-200">
          ...
          <button className="px-2 hover:bg-gray-700" onClick={(e) => e.stopPropagation()}>_</button>
          <button className="px-2 hover:bg-gray-700" onClick={(e) => e.stopPropagation()}>□</button>
          <button className="px-2 hover:bg-red-600" onClick={(e) => e.stopPropagation()}>×</button>
        </div>
    ...
    <div className="flex flex-col">
      <div className="flex items-center p-2 bg-gray-200 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-700 rounded-t-lg">
        <div className="flex space-x-2">
          <div className="w-3 h-3 rounded-full bg-red-500 hover:bg-red-600 cursor-pointer" onClick={(e) => e.stopPropagation()} />
          <div className="w-3 h-3 rounded-full bg-yellow-500 hover:bg-yellow-600 cursor-pointer" onClick={(e) => e.stopPropagation()} />
          <div className="w-3 h-3 rounded-full bg-green-500 hover:bg-green-600 cursor-pointer" onClick={(e) => e.stopPropagation()} />
        </div>
